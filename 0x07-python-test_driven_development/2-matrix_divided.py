...
def matrix_divided(matrix, div):
    """
    Divide all elements of a matrix by a given number and round to 2 decimal places.
    ...
    Returns:
        list of lists: A new matrix where all elements are divided by the given number and rounded to 2 decimal places.
