...
Contains a function that writes a string to a text file (UTF-8) and returns numof char
"""
...
def write_file(filename="", text=""):
    ...
    Args:
        filename (str, optional): The name of the text file to write. Defaults to "".
