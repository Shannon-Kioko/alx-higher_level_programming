...
class Square:
    ...
    Attributes:
        size (int): The size of square's sides.
    ...
    def size(self, value):
        """
        Setter for size of the square's sides.
    ...
    def position(self):
        """
        tuple: The pos of the square's top-left corner.
        """
    ...
    def my_print(self):
        """
        Prints square using "#" characters and spaces.
        """
        if self.__size == 0:
            print()
        else:
