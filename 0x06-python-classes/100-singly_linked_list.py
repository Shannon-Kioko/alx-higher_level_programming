...
class Node:
    ...
    def __init__(self, data, next_node=None):
        """
        Inits a Node instance with the given data and next node.
    ...
    def data(self, value):
        """
        Setter for the data stored inside the node.

        Args:
            value (int): The data to be stored in the node.

        Raises:
            TypeError: If provided data is not an integer.
        """
    ...
    def next_node(self):
        """
        Node: The next node in linked list.
        """
...
class SinglyLinkedList:
    ...
    def __init__(self):
        """
        Inits an empty SinglyLinkedList.
        """
        self.head = None
    ...
    def __str__(self):
        """
        Returns a string rep of the linked list.
